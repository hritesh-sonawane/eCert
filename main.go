...
func main() {
	...
	// Banner - Logo
	pdf.ImageOptions("images/sharingan.png", 248.0, 0+(bannerHt-(bannerHt/1.5))/2.0, 0, bannerHt/1.5, false, gofpdf.ImageOptions{
		ReadDpi: true,
	}, 0, "")
	...
	pdf.MultiCell(124.0, lineHt*1.5, "(123) 456-7890\nhr7tesh@gmail.com\nhr7tesh.tech", gofpdf.BorderNone, gofpdf.AlignRight, false)
	...
	summaryBlock(pdf, xIndent*2.0+lineHt*12.5, bannerHt+lineHt*6.25, "Date of Issue", "07/23/2021")
